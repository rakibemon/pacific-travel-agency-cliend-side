                        ...
                        <Nav className="me-auto d-flex justify-content-start align-items-center">
                            ...
                            {(user.displayName || user.email) &&
                                ...
                                <div className='d-md-flex text-center'>
                                    <NavLink activeStyle={activeStyle} className={(user.displayName || user.email) ? "nav-link-user-active" : ''} to='/mybooking'> My Booking </NavLink>

                                    <NavLink activeStyle={activeStyle} className={(user.displayName || user.email) ? "nav-link-user-active" : ''} to='/manageallbooking'> Manage All bookings </NavLink>

                                    <NavLink activeStyle={activeStyle} className={(user.displayName || user.email) ? "nav-link-user-active" : ''} to='/addaservice'> Add a Service </NavLink>
                                </div>
